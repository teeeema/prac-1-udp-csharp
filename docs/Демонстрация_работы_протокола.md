...
![Запуск сервера](docs/photos/01_server_start.png)
...
![Работа клиента](docs/photos/02_client_exchange.png)
...
![Обработка команд сервером](docs/photos/03_server_log.png)
